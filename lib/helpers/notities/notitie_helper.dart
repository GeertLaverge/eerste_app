...
class NotitieHelper {
  ...
  static List<NotitieModel> sorteerVoorDag(List<NotitieModel> lijst) {
    final kopie = [...lijst];
    ...
    kopie.sort((a, b) {
      ...
      return a.aangemaaktOp.compareTo(b.aangemaaktOp);
    });

    return kopie;
  }

  static bool heeftOpenNotities(List<NotitieModel> lijst) {
    return lijst.any((n) => !n.afgewerkt);
  }
}
