// THIMACO-CONTROLE: PRIJS-PER-ARTIKEL-BIBLIOTHEEK-MODEL-20260813
import 'offerte_artikel_prijs_data_model.dart';

/// Herbruikbare bibliotheekregel onder Instellingen -> Offerteprijzen.
///
/// Dit model is bewust GEEN live koppeling met een offerte. Wanneer een regel
/// later naar een positie wordt overgenomen, wordt een onafhankelijke
/// [OffertePrijsPerPositieRegelModel] gemaakt met een nieuw id.
class OffertePrijsPerArtikelTemplateModel {
  ...
  OffertePrijsPerArtikelTemplateModel copyWith({
    String? id,
    String? omschrijving,
    ...
    return OffertePrijsPerArtikelTemplateModel(
      id: id ?? this.id,
  ...
  OffertePrijsPerArtikelTemplateModel metWijzigingsDatum() {
    return copyWith(gewijzigdOp: DateTime.now().toUtc().toIso8601String());
  }

  /// Maakt een zelfstandige lokale prijsregel. Er wordt bewust geen template-id
  /// opgeslagen in de positie, zodat latere wijzigingen aan Instellingen nooit
  /// bestaande offertes kunnen wijzigen.
  OffertePrijsPerPositieRegelModel maakPositieRegel({required String nieuwId}) {
  ...
  factory OffertePrijsPerArtikelTemplateModel.fromJson(
