// THIMACO-CONTROLE: VOORZETSCREEN-PDF-KEUZEVRAGEN-MOTOREN-20260730
...
class OffertePdfVoorzetscreenWidget {
                  ...
                  pw.RichText(
                    text: pw.TextSpan(
                      children: <pw.InlineSpan>[
                        pw.TextSpan(
                          text: '€ ${totaalVoorKorting.toStringAsFixed(2)}',
                          style: pw.TextStyle(
                            color: OffertePdfArtikelLayoutHelper.tekstDonker,
                            fontSize: 12.2,
                            fontWeight: pw.FontWeight.bold,
  ...
  static pw.Widget _bouwTekening(
    ...
    final onderlatOnder = onderlatBoven + onderlatHoogte;
...
<svg xmlns="http://www.w3.org/2000/svg" width="$breedte" height="$hoogte" viewBox="0 0 350 250">
  ...
  <rect x="${n(frontLinks)}" y="${n(kastOnder)}" width="${n(geleiderBreedte)}" height="${n(onderlatOnder - kastOnder)}" fill="#F8FAFC" stroke="#374151" stroke-width="1.1"/>
  <rect x="${n(frontRechts - geleiderBreedte)}" y="${n(kastOnder)}" width="${n(geleiderBreedte)}" height="${n(onderlatOnder - kastOnder)}" fill="#F8FAFC" stroke="#374151" stroke-width="1.1"/>
