              ...
              ElevatedButton.icon(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute<void>(
                      builder: (_) {
                        return const OpmetingVoorzetrolluikInstellingenPagina();
                      },
                    ),
                  );
                },
                icon: const Icon(Icons.blinds_outlined),
                label: const Text('Voorzetrolluiken'),
                style: _knopStijl(groen),
              ),
              const SizedBox(height: 12),
              ElevatedButton.icon(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute<void>(
                      builder: (_) {
                        return const OpmetingUitvalschermInstellingenPagina();
                      },
                    ),
                  );
                },
                icon: const Icon(Icons.wb_sunny_outlined),
                label: const Text('Uitvalschermen'),
                style: _knopStijl(groen),
              ),
              const SizedBox(height: 12),
              ElevatedButton.icon(
              ...
              ElevatedButton.icon(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute<void>(
                      builder: (_) {
                        return const OffertePrijzenPagina();
                      },
                    ),
                  );
                },
                icon: const Icon(Icons.euro_rounded),
                label: const Text('Offerteprijzen'),
                style: _knopStijl(groen),
              ),
              const SizedBox(height: 12),
              ElevatedButton.icon(
