...
class MagazijnBestelbonPdfService {
  ...
  static Future<void> afdrukken({
    ...
    final bytes = await maakPdf(leverancier: leverancier, regels: regels);
    await Printing.layoutPdf(
      name: _bestandsNaam(leverancier),
  ...
  static Future<void> delen({
    ...
    final bytes = await maakPdf(leverancier: leverancier, regels: regels);
    await Printing.sharePdf(bytes: bytes, filename: _bestandsNaam(leverancier));
  }
  ...
  static pw.TableRow _artikelRij(MagazijnBestelbonRegel regel) {
    return pw.TableRow(
      children: <pw.Widget>[
        ...
        _cel('${regel.aantal} ${regel.artikel.eenheid}'),
      ],
    );
  }
  ...
  static String _bestandsNaam(MagazijnLeverancier leverancier) {
